...
dependencies {
    ...
    try {
        ...
        implementation("com.datadatdat:nop-remote-server:1.7.2")
        implementation("com.datadatdat:ssh-remote-server:1.7.2")
        implementation("com.datadatdat:s3-remote-server:1.7.2")
        implementation("com.datadatdat:s3web-remote-server:1.7.2")
    } catch (e: Exception) {

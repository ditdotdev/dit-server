...
dependencies {
    ...
    implementation("dev.dit:command-executor:1.9.7")
    ...
    try {
        ...
        implementation("dev.dit:dit-remote-server:1.9.7")
        implementation("dev.dit:nop-remote-server:1.9.7")
        implementation("dev.dit:ssh-remote-server:1.9.7")
        implementation("dev.dit:s3-remote-server:1.9.7")
        implementation("dev.dit:s3web-remote-server:1.9.7")
    } catch (e: Exception) {

...
dependencies {
    ...
    try {
        ...
        implementation("dev.dit:dit-remote-server:1.10.2")
        implementation("dev.dit:nop-remote-server:1.10.2")
        implementation("dev.dit:ssh-remote-server:1.10.2")
        implementation("dev.dit:s3-remote-server:1.10.2")
        implementation("dev.dit:s3web-remote-server:1.10.2")
    } catch (e: Exception) {

...
class RemoteOrchestrator(
    ...
    fun listRemoteCommits(
        ...
        val commits =
            services.remoteProvider(remote.provider).listCommits(
                remote.properties,
                validateParameters(params).properties,
                getTags(tags),
            )
    ...
    fun getRemoteCommit(
        ...
        val commit =
            services.remoteProvider(remote.provider).getCommit(
                remote.properties,
                validateParameters(params).properties,
                commitId,
            )
